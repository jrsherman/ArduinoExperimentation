...
void loop()
{
 ...
 Tlc.set(4, (int)(setDim*sin(setDecay*numberZ-2)+setDim));
  ...
  Tlc.set(14, (int)(setDim*sin(setDecay*numberZ-8)+setDim));
    ...
    Tlc.set(15, (int)(setDim*sin(setDecay*numberZ-1.4)+setDim));
  Tlc.set(16, (int)(setDim*sin(setDecay*numberZ-10)+setDim));
  Tlc.set(17, (int)(setDim*sin(setDecay*numberZ-10)+setDim));

   Tlc.set(18, (int)(setDim*sin(setDecay*numberZ-1.6)+setDim));
    Tlc.set(19, (int)(setDim*sin(setDecay*numberZ-12)+setDim));
     Tlc.set(20, (int)(setDim*sin(setDecay*numberZ-12)+setDim));
     
     
     
   Tlc.set(21, (int)(setDim*sin(setDecay*numberZ-1.8)+setDim));
   Tlc.set(22, (int)(setDim*sin(setDecay*numberZ-14)+setDim));
   Tlc.set(23, (int)(setDim*sin(setDecay*numberZ-14)+setDim));
   
   Tlc.set(24, (int)(setDim*sin(setDecay*numberZ-2)+setDim));
   Tlc.set(25, (int)(setDim*sin(setDecay*numberZ-16)+setDim));
   Tlc.set(26, (int)(setDim*sin(setDecay*numberZ-16)+setDim));
   
   Tlc.set(27, (int)(setDim*sin(setDecay*numberZ-2.2)+setDim));
   Tlc.set(28, (int)(setDim*sin(setDecay*numberZ-18)+setDim));
   Tlc.set(29, (int)(setDim*sin(setDecay*numberZ-18)+setDim));
