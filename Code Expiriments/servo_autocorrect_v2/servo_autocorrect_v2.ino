...
void loop()
{
  ...
  if(initialVal<= 5){
    ...
    if(initialVal == 1)
      X1 = averageConstrained;
    
    else if(initialVal == 2)
      X2 = averageConstrained;
    
    else if(initialVal == 3){
      X3 = averageConstrained;
  
    }
    else if(initialVal == 4)
      X4 = averageConstrained;
  ...
  int average = (1*x1 + 1*x2 + 1*x3 + 2*x4 + 1*x5)/6;
