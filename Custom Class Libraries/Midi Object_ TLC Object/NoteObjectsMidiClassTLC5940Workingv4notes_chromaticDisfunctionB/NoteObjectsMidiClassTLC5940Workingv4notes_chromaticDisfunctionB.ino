...
void loop() {
 ...
 // Serial.println(average-20);   
  ...
  Serial.println(average-24);
     ...
     if(average-24 > 0 && average-24 <= 2 && notePop==0){
     ...
     else if(average-24 > 2 && average-24 <= 3){
       Serial.print("buffer_1 ");
      }



      else if(average-24 > 3 && average-24 <= 5 && notePop1==0){
      ...
      else if(average-24 > 5 && average-24 <= 6){
        Serial.print("buffer_2 ");
      }
      
      

      else if(average-24 > 6 && average-24 <= 8 && notePop2==0){
