...
void loop() {
 ...
 // Serial.println(average-20);   
  ...
  //Serial.println(average-23.5);
     ...
     if(average-23.5 > 70 && basePop ==0){
      ...
      Tlc.update();
     ...
     else if(average-23.5 > 0 && average-23.5 <= 1 && notePop==0){
     ...
     else if(average-23.5 > 1 && average-23.5 <= 1.5){
       Serial.print("buffer_1 \n");
      }

      else if(average-23.5 > 1.5 && average-23.5 <= 4 && notePop1==0){
      ...
      else if(average-23.5 > 4 && average-23.5 <= 4.5){
        Serial.print("buffer_2 \n");
      }
      
      
      else if(average-23.5 > 4.5 && average-23.5 <= 9 && notePop2==0){
        Serial.print("--------------------region3---------------\n");
        notePop2=1;
     ...
     else if(average-23.5 > 9 && average-23.5 <= 10){
       Serial.print("buffer_1\n ");
      }
       ...
       else if(average-23.5 > 10 && average-23.5 <= 15 && notePop4==0){
        Serial.print("--------------------region4---------------\n");
        notePop4=1;
        notePop2=0;
        notePop=0;
        notePop1=0;
       ...
       else if(average-23.5 > 15 && average-23.5 <= 17){
       Serial.print("buffer_1 \n");
      }

       else if(average-23.7 > 17 && average-23.5 <= 20 && notePop5==0){
        Serial.print("--------------------region5---------------\n");
        basePop=0;
        notePop=0;
        notePop1=0;
        notePop2=0; 
  ...
  /* 
  if(lastVal-1 < average && lastVal+1  > average)
    average = lastVal;
  ...
  if(distance-20 > 20){
      ...
      else if(average-20 > noteDivision*0 && average-20 <= 1 && notePop==0){
        for(int i = 0; i < 30; i ++){
          Tlc.set(i, 0);
        }
        Tlc.update();
     ...
     else if(average-20 >= 2 && average-20 <= 6 && notePop2==0){
       for(int i = 0; i < 30; i ++){
          Tlc.set(i, 0);
        }
        Tlc.update();
      ...
      else if(average-20 > 6 && average-20 <= 12 && notePop3==0){
        notePop=0;
        notePop2=0;
        notePop4=0;
        Serial.println("pop3");
  ...
  else if(average-20 > 12 && average-20 <= 20 && notePop4==0){
